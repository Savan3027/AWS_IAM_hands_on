...
Input Features:
Numeric housing features such as LotArea, OverallQual, SquareFootage, Basement features, etc.

🏗️ Architecture Workflow

Dataset stored in Amazon S3

Development performed in SageMaker Studio

Data preprocessing and train–test split

Model training using SageMaker built-in Linear Learner

Model deployed as real-time endpoint

Predictions generated via endpoint

Model evaluated using RMSE

Endpoint deleted to control AWS cost
...
Ability to build and deploy ML models in cloud
